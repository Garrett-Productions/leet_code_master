...
// we need to compare the length of the array with index,  if i is > index, set the next position equal to the current position, and take in the param index as an arguyement to my array and set it = to the value 
